...
monthdict = {'ebr': 4, 'est': 8, 'mys efan': 6, 'mys kevardhu': 12, 'hed': 10, 'efn': 6, 'gor': 7, 'mys hedra': 10, 'whe': 2, 'mys genver': 1, 'mys du': 11, 'mer': 3, 'kev': 12, 'du': 11, 'gen': 1, 'me': 5, 'mys gwyngala': 9, 'mys merth': 3, 'mys whevrel': 2, 'gwn': 9, 'mys ebrel': 4, 'mys gortheren': 7, 'mys me': 5, 'mye est': 8}
t_SHORTMONTH = r'(?i)gen|whe|mer|ebr|me|efn|gor|est|gwn|hed|du|kev'
t_LONGMONTH = r'(?i)mys genver|mys whevrel|mys merth|mys ebrel|mys me|mys efan|mys gortheren|mye est|mys gwyngala|mys hedra|mys du|mys kevardhu'
