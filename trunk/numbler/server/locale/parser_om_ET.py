...
monthdict = {'onk': 10, 'sadaasa': 11, 'sad': 11, 'hagayya': 8, 'elba': 4, 'cam': 5, 'elb': 4, 'bitooteessa': 3, 'hag': 8, 'mud': 12, 'amajjii': 1, 'wax': 6, 'ado': 7, 'muddee': 12, 'onkololeessa': 10, 'caamsa': 5, 'adooleessa': 7, 'ama': 1, 'fuulbana': 9, 'bit': 3, 'guraandhala': 2, 'gur': 2, 'waxabajjii': 6, 'ful': 9}
t_SHORTMONTH = r'(?i)ama|gur|bit|elb|cam|wax|ado|hag|ful|onk|sad|mud'
t_LONGMONTH = r'(?i)amajjii|guraandhala|bitooteessa|elba|caamsa|waxabajjii|adooleessa|hagayya|fuulbana|onkololeessa|sadaasa|muddee'
