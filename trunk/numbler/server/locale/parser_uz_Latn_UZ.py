...
monthdict = {'apr': 4, 'rajab': 7, 'zil-qa\xca\xbfda': 11, 'sen': 9, 'avg': 8, 'jumodiul-ulo': 5, 'shavvol': 10, 'zil-hijja': 12, 'fev': 2, 'iyun': 6, 'rabiul-oxir': 4, 'mar': 3, 'okt': 10, 'may': 5, 'safar': 2, 'jumodiul-uxro': 6, 'yanv': 1, 'noya': 11, 'rabiul-avval': 3, 'iyul': 7, 'dek': 12, 'sha\xca\xbfbon': 8, 'muharram': 1, 'ramazon': 9}
t_SHORTMONTH = r'(?i)yanv|fev|mar|apr|may|iyun|iyul|avg|sen|okt|noya|dek'
t_LONGMONTH = r'(?i)muharram|safar|rabiul-avval|rabiul-oxir|jumodiul-ulo|jumodiul-uxro|rajab|shaʿbon|ramazon|shavvol|zil-qaʿda|zil-hijja'
