...
monthdict = {'sep': 9, 'apr': 4, 'januar': 1, 'nov': 11, 'okt': 10, 'm\xc3\xa4rz': 3, 'feb': 2, 'aug': 8, 'jan': 1, 'september': 9, 'oktober': 10, 'juni': 6, 'august': 8, 'juli': 7, 'jun': 6, 'jul': 7, 'dezember': 12, 'mai': 5, 'november': 11, 'dez': 12, 'mrz': 3, 'april': 4, 'februar': 2}
t_SHORTMONTH = r'(?i)jan|feb|mrz|apr|mai|jun|jul|aug|sep|okt|nov|dez'
t_LONGMONTH = r'(?i)januar|februar|märz|april|mai|juni|juli|august|september|oktober|november|dezember'
