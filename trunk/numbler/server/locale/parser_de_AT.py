...
monthdict = {'sep': 9, 'apr': 4, 'j\xc3\xa4n': 1, 'november': 11, 'august': 8, 'm\xc3\xa4rz': 3, 'feb': 2, 'aug': 8, 'september': 9, 'oktober': 10, 'juni': 6, 'okt': 10, 'juli': 7, 'jun': 6, 'm\xc3\xa4r': 3, 'dezember': 12, 'jul': 7, 'mai': 5, 'j\xc3\xa4nner': 1, 'nov': 11, 'dez': 12, 'april': 4, 'februar': 2}
t_SHORTMONTH = r'(?i)jän|feb|mär|apr|mai|jun|jul|aug|sep|okt|nov|dez'
t_LONGMONTH = r'(?i)jänner|februar|märz|april|mai|juni|juli|august|september|oktober|november|dezember'
...
t_CLOCK = r'(?i)am|pm|p|a|vorm.|nachm.'
def p_datesep(p):
    ''' datesep : SLASH
                | DASH
                | SPACE
