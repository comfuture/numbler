...
monthdict = {'julij': 7, 'sep': 9, 'september': 9, 'december': 12, 'avg': 8, 'januar': 1, 'nov': 11, 'junij': 6, 'feb': 2, 'jan': 1, 'apr': 4, 'oktober': 10, 'mar': 3, 'okt': 10, 'marec': 3, 'jun': 6, 'jul': 7, 'november': 11, 'maj': 5, 'april': 4, 'februar': 2, 'dec': 12, 'avgust': 8}
t_SHORTMONTH = r'(?i)jan|feb|mar|apr|maj|jun|jul|avg|sep|okt|nov|dec'
t_LONGMONTH = r'(?i)januar|februar|marec|april|maj|junij|julij|avgust|september|oktober|november|december'
