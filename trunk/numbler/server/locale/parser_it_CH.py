...
monthdict = {'luglio': 7, 'set': 9, 'apr': 4, 'settembre': 9, 'giugno': 6, 'giu': 6, 'feb': 2, 'febbraio': 2, 'gennaio': 1, 'lug': 7, 'maggio': 5, 'aprile': 4, 'mar': 3, 'marzo': 3, 'agosto': 8, 'novembre': 11, 'dicembre': 12, 'mag': 5, 'nov': 11, 'ott': 10, 'gen': 1, 'ago': 8, 'ottobre': 10, 'dic': 12}
t_SHORTMONTH = r'(?i)gen|feb|mar|apr|mag|giu|lug|ago|set|ott|nov|dic'
t_LONGMONTH = r'(?i)gennaio|febbraio|marzo|aprile|maggio|giugno|luglio|agosto|settembre|ottobre|novembre|dicembre'
