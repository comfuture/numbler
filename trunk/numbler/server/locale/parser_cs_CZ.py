...
monthdict = {'\xc4\x8dervna': 6, 'sep': 9, 'apr': 4, 'z\xc3\xa1\xc5\x99\xc3\xad': 9, '\xc4\x8dervence': 7, '\xc3\xbanora': 2, 'feb': 2, 'aug': 8, 'prosince': 12, 'jan': 1, 'kv\xc4\x9btna': 5, 'oct': 10, 'mar': 3, 'may': 5, 'jun': 6, '\xc5\x99\xc3\xadjna': 10, 'jul': 7, 'srpna': 8, 'ledna': 1, 'nov': 11, 'dubna': 4, 'b\xc5\x99ezna': 3, 'listopadu': 11, 'dec': 12}
t_SHORTMONTH = r'(?i)jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec'
t_LONGMONTH = r'(?i)ledna|února|března|dubna|května|června|července|srpna|září|října|listopadu|prosince'
