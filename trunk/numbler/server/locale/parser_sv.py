...
monthdict = {'sep': 9, 'apr': 4, 'december': 12, 'nov': 11, 'feb': 2, 'aug': 8, 'jan': 1, 'september': 9, 'mars': 3, 'oktober': 10, 'juni': 6, 'mar': 3, 'okt': 10, 'juli': 7, 'jun': 6, 'jul': 7, 'november': 11, 'maj': 5, 'augusti': 8, 'april': 4, 'februari': 2, 'januari': 1, 'dec': 12}
t_SHORTMONTH = r'(?i)jan|feb|mar|apr|maj|jun|jul|aug|sep|okt|nov|dec'
t_LONGMONTH = r'(?i)januari|februari|mars|april|maj|juni|juli|augusti|september|oktober|november|december'
