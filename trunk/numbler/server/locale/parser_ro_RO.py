...
monthdict = {'februarie': 2, 'sep': 9, 'apr': 4, 'iulie': 7, 'noiembrie': 11, 'ianuarie': 1, 'august': 8, 'ian': 1, 'feb': 2, 'octombrie': 10, 'aug': 8, 'aprilie': 4, 'mar': 3, 'iul': 7, 'iun': 6, 'iunie': 6, 'mai': 5, 'nov': 11, 'decembrie': 12, 'septembrie': 9, 'oct': 10, 'dec': 12, 'martie': 3}
t_SHORTMONTH = r'(?i)ian|feb|mar|apr|mai|iun|iul|aug|sep|oct|nov|dec'
t_LONGMONTH = r'(?i)ianuarie|februarie|martie|aprilie|mai|iunie|iulie|august|septembrie|octombrie|noiembrie|decembrie'
