...
monthdict = {'sep': 9, 'apr': 4, 'december': 12, 'januar': 1, 'nov': 11, 'august': 8, 'feb': 2, 'aug': 8, 'jan': 1, 'september': 9, 'oktober': 10, 'juni': 6, 'mar': 3, 'okt': 10, 'juli': 7, 'jun': 6, 'jul': 7, 'november': 11, 'maj': 5, 'marts': 3, 'april': 4, 'februar': 2, 'dec': 12}
t_SHORTMONTH = r'(?i)jan|feb|mar|apr|maj|jun|jul|aug|sep|okt|nov|dec'
t_LONGMONTH = r'(?i)januar|februar|marts|april|maj|juni|juli|august|september|oktober|november|december'
