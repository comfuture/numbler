...
monthdict = {'sep': 9, 'apr': 4, 'novemberi': 11, 'septemberi': 9, 'decemberi': 12, 'feb': 2, 'aug': 8, 'jan': 1, 'aprili': 4, 'augustusi': 8, 'juni': 6, 'mar': 3, 'okt': 10, 'juli': 7, 'jun': 6, 'jul': 7, 'oktoberi': 10, 'nov': 11, 'maj': 5, 'martsi': 3, 'maji': 5, 'februari': 2, 'januari': 1, 'dec': 12}
t_SHORTMONTH = r'(?i)jan|feb|mar|apr|maj|jun|jul|aug|sep|okt|nov|dec'
t_LONGMONTH = r'(?i)januari|februari|martsi|aprili|maji|juni|juli|augustusi|septemberi|oktoberi|novemberi|decemberi'
