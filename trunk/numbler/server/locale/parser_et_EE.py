...
monthdict = {'veebr': 2, 'august': 8, 'oktoober': 10, 'veebruar': 2, 'okt': 10, 'aug': 8, 'apr': 4, 'sept': 9, 'm\xc3\xa4rts': 3, 'detsember': 12, 'september': 9, 'november': 11, 'dets': 12, 'aprill': 4, 'mai': 5, 'juuni': 6, 'juuli': 7, 'nov': 11, 'jaan': 1, 'jaanuar': 1}
t_SHORTMONTH = r'(?i)jaan|veebr|märts|apr|mai|juuni|juuli|aug|sept|okt|nov|dets'
t_LONGMONTH = r'(?i)jaanuar|veebruar|märts|aprill|mai|juuni|juuli|august|september|oktoober|november|detsember'
