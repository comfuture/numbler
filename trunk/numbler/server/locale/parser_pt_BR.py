...
monthdict = {'set': 9, 'agosto': 8, 'out': 10, 'jan': 1, 'mar\xc3\xa7o': 3, 'dezembro': 12, 'abril': 4, 'fev': 2, 'abr': 4, 'maio': 5, 'novembro': 11, 'mar': 3, 'janeiro': 1, 'jun': 6, 'jul': 7, 'mai': 5, 'nov': 11, 'ago': 8, 'dez': 12, 'fevereiro': 2, 'junho': 6, 'julho': 7, 'outubro': 10, 'setembro': 9}
t_SHORTMONTH = r'(?i)jan|fev|mar|abr|mai|jun|jul|ago|set|out|nov|dez'
t_LONGMONTH = r'(?i)janeiro|fevereiro|março|abril|maio|junho|julho|agosto|setembro|outubro|novembro|dezembro'
...
def p_longdate(p):
    ' longdate : INTEGER CUSTOMLIT0 month CUSTOMLIT0 INTEGER '
    monthasint = False
    day = int(p[1])
    month = p[3]
    year = int(p[5])
