...
monthdict = {'tem': 7, 'ekim': 10, 'a\xc4\x9fu': 8, 'ara': 12, '\xc5\x9eubat': 2, 'temmuz': 7, 'oca': 1, 'eyl': 9, 'ocak': 1, 'mart': 3, 'haz': 6, 'a\xc4\x9fustos': 8, 'mar': 3, 'may': 5, 'kas': 11, 'nis': 4, 'eyl\xc3\xbcl': 9, 'aral\xc4\xb1k': 12, 'nisan': 4, 'eki': 10, 'may\xc4\xb1s': 5, '\xc5\x9eub': 2, 'haziran': 6, 'kas\xc4\xb1m': 11}
t_SHORTMONTH = r'(?i)oca|Şub|mar|nis|may|haz|tem|ağu|eyl|eki|kas|ara'
t_LONGMONTH = r'(?i)ocak|Şubat|mart|nisan|mayıs|haziran|temmuz|ağustos|eylül|ekim|kasım|aralık'
...
t_DAYINWEEK = r'paz|pzt|sal|Çar|per|cum|cmt|pazar|pazartesi|salı|Çarşamba|perşembe|cuma|cumartesi'
...
def p_longdate(p):
    ' longdate : INTEGER datesep month datesep INTEGER datesep DAYINWEEK '
    monthasint = False
    day = int(p[1])
    month = p[3]
    year = int(p[5])
