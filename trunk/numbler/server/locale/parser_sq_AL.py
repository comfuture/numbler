...
monthdict = {'dhjetor': 12, 'pri': 4, 'shtator': 9, 'qer': 6, 'korrik': 7, 'tet': 10, 'shkurt': 2, 'tetor': 10, 'dhj': 12, 'prill': 4, 'jan': 1, 'mars': 3, 'n\xc3\xabntor': 11, 'kor': 7, 'mar': 3, 'qershor': 6, 'maj': 5, 'n\xc3\xabn': 11, 'janar': 1, 'gusht': 8, 'sht': 9, 'gsh': 8, 'shk': 2}
t_SHORTMONTH = r'(?i)jan|shk|mar|pri|maj|qer|kor|gsh|sht|tet|nën|dhj'
t_LONGMONTH = r'(?i)janar|shkurt|mars|prill|maj|qershor|korrik|gusht|shtator|tetor|nëntor|dhjetor'
