...
monthdict = {'d\xc3\xa9c.': 12, 'nov.': 11, 'sept.': 9, 'd\xc3\xa9cembre': 12, 'janv.': 1, 'f\xc3\xa9vr.': 2, 'novembre': 11, 'f\xc3\xa9vrier': 2, 'juil.': 7, 'juillet': 7, 'avr.': 4, 'janvier': 1, 'octobre': 10, 'oct.': 10, 'juin': 6, 'avril': 4, 'mars': 3, 'mai': 5, 'ao\xc3\xbbt': 8, 'septembre': 9}
t_SHORTMONTH = r'(?i)janv\.|févr\.|mars|avr\.|mai|juin|juil\.|août|sept\.|oct\.|nov\.|déc\.'
t_LONGMONTH = r'(?i)janvier|février|mars|avril|mai|juin|juillet|août|septembre|octobre|novembre|décembre'
