...
monthdict = {'desemba': 12, 'sep': 9, 'apr': 4, 'oktoba': 10, 'septemba': 9, 'feb': 2, 'jan': 1, 'aprili': 4, 'machi': 3, 'julai': 7, 'juni': 6, 'agosti': 8, 'mar': 3, 'okt': 10, 'mei': 5, 'jun': 6, 'jul': 7, 'nov': 11, 'ago': 8, 'novemba': 11, 'des': 12, 'februari': 2, 'januari': 1}
t_SHORTMONTH = r'(?i)jan|feb|mar|apr|mei|jun|jul|ago|sep|okt|nov|des'
t_LONGMONTH = r'(?i)januari|februari|machi|aprili|mei|juni|julai|agosti|septemba|oktoba|novemba|desemba'
