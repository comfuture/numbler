...
monthdict = {'aug.': 8, 'december': 12, '\xc3\xa1prilis': 4, '\xc3\xa1pr.': 4, 'j\xc3\xbanius': 6, 'augusztus': 8, 'febru\xc3\xa1r': 2, 'm\xc3\xa1jus': 5, 'm\xc3\xa1j.': 5, 'szept.': 9, 'okt\xc3\xb3ber': 10, 'jan.': 1, 'febr.': 2, 'dec.': 12, 'j\xc3\xbal.': 7, 'november': 11, 'szeptember': 9, 'm\xc3\xa1rc.': 3, 'm\xc3\xa1rcius': 3, 'nov.': 11, 'janu\xc3\xa1r': 1, 'j\xc3\xban.': 6, 'j\xc3\xbalius': 7, 'okt.': 10}
t_SHORTMONTH = r'(?i)jan\.|febr\.|márc\.|ápr\.|máj\.|jún\.|júl\.|aug\.|szept\.|okt\.|nov\.|dec\.'
t_LONGMONTH = r'(?i)január|február|március|április|május|június|július|augusztus|szeptember|október|november|december'
...
def p_longdate(p):
    ' longdate : INTEGER datesep datesep month datesep INTEGER datesep '
    monthasint = False
    day = int(p[6])
    month = p[4]
    year = int(p[1])
