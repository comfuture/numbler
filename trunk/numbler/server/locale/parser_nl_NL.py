...
monthdict = {'sep': 9, 'apr': 4, 'december': 12, 'augustus': 8, 'nov': 11, 'feb': 2, 'aug': 8, 'jan': 1, 'september': 9, 'oktober': 10, 'juni': 6, 'okt': 10, 'jun': 6, 'juli': 7, 'mei': 5, 'jul': 7, 'maart': 3, 'november': 11, 'mrt': 3, 'april': 4, 'februari': 2, 'januari': 1, 'dec': 12}
t_SHORTMONTH = r'(?i)jan|feb|mrt|apr|mei|jun|jul|aug|sep|okt|nov|dec'
t_LONGMONTH = r'(?i)januari|februari|maart|april|mei|juni|juli|augustus|september|oktober|november|december'
