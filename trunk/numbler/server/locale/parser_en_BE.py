...
t_DAYINWEEK = r'sun|mon|tue|wed|thu|fri|sat|sunday|monday|tuesday|wednesday|thursday|friday|saturday'
...
def p_longdate(p):
    ' longdate : DAYINWEEK datesep INTEGER datesep month datesep INTEGER '
    monthasint = False
    day = int(p[3])
    month = p[5]
    year = int(p[7])
