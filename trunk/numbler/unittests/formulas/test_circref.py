...
class cirrefTestCase(sheetTester):
    sheets = [
        {
        'name':'circrefsheet',
        'cells':[
    ...
    def testSubtotal(self):
        sht = self.sheetHandles['circrefsheet']
        val = self.value(sht,'a4')
        self.checkException(sht,'a4',SSRefError)
        self.checkException(sht,'b10',SSRefError)
        self.checkException(sht,'R3',SSRefError)
        self.checkException(sht,'c100',SSRefError)
        self.checkException(sht,'a5',SSRefError)
        self.checkException(sht,'a6',SSRefError)                
