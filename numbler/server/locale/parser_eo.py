...
monthdict = {'julio': 7, 'sep': 9, 'apr': 4, 'oktobro': 10, 'feb': 2, 'junio': 6, 'jan': 1, 'aprilo': 4, 'septembro': 9, 'a\xc5\xadg': 8, 'novembro': 11, 'mar': 3, 'okt': 10, 'jun': 6, 'jul': 7, 'a\xc5\xadgusto': 8, 'nov': 11, 'maj': 5, 'majo': 5, 'februaro': 2, 'decembro': 12, 'marto': 3, 'dec': 12, 'januaro': 1}
t_SHORTMONTH = r'(?i)jan|feb|mar|apr|maj|jun|jul|aŭg|sep|okt|nov|dec'
t_LONGMONTH = r'(?i)januaro|februaro|marto|aprilo|majo|junio|julio|aŭgusto|septembro|oktobro|novembro|decembro'
