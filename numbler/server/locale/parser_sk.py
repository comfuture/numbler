...
monthdict = {'december': 12, 'febru\xc3\xa1r': 2, 'mar': 3, 'feb': 2, 'okt': 10, 'aug': 8, 'sep': 9, 'apr': 4, 'm\xc3\xa1j': 5, 'marec': 3, 'apr\xc3\xadl': 4, 'j\xc3\xban': 6, 'j\xc3\xbal': 7, 'jan': 1, 'september': 9, 'okt\xc3\xb3ber': 10, 'janu\xc3\xa1r': 1, 'nov': 11, 'dec': 12, 'november': 11, 'august': 8}
t_SHORTMONTH = r'(?i)jan|feb|mar|apr|máj|jún|júl|aug|sep|okt|nov|dec'
t_LONGMONTH = r'(?i)január|február|marec|apríl|máj|jún|júl|august|september|október|november|december'
