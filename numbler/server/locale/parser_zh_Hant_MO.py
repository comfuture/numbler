...
monthdict = {'1\xe6\x9c\x88': 1, '\xe5\x85\xab\xe6\x9c\x88': 8, '11\xe6\x9c\x88': 11, '\xe4\xb9\x9d\xe6\x9c\x88': 9, '\xe4\xba\x94\xe6\x9c\x88': 5, '\xe5\x8d\x81\xe6\x9c\x88': 10, '\xe4\xba\x8c\xe6\x9c\x88': 2, '5\xe6\x9c\x88': 5, '\xe4\xb8\x89\xe6\x9c\x88': 3, '\xe4\xb8\x80\xe6\x9c\x88': 1, '7\xe6\x9c\x88': 7, '12\xe6\x9c\x88': 12, '10\xe6\x9c\x88': 10, '\xe5\x8d\x81\xe4\xb8\x80\xe6\x9c\x88': 11, '9\xe6\x9c\x88': 9, '\xe5\x9b\x9b\xe6\x9c\x88': 4, '\xe5\x85\xad\xe6\x9c\x88': 6, '4\xe6\x9c\x88': 4, '\xe5\x8d\x81\xe4\xba\x8c\xe6\x9c\x88': 12, '2\xe6\x9c\x88': 2, '\xe4\xb8\x83\xe6\x9c\x88': 7, '8\xe6\x9c\x88': 8, '3\xe6\x9c\x88': 3, '6\xe6\x9c\x88': 6}
t_SHORTMONTH = r'(?i)1月|2月|3月|4月|5月|6月|7月|8月|9月|10月|11月|12月'
...
def p_shortdate(p):
    ' shortdate : INTEGER CUSTOMLIT0 INTEGER CUSTOMLIT1 INTEGER CUSTOMLIT2 '
    monthasint = True
    month = p[3]
    day = int(p[5])
    year = int(p[1])
...
def p_medtimeclock(p):
    ' medtimeclock : CLOCK INTEGER TIMESEP INTEGER '
    t = TimeNode(int(p[2]),int(p[4]))
    t.setAMPM(p[1])
    p[0] = t


def p_longtimeclock(p):
    ' longtimeclock : CLOCK INTEGER TIMESEP INTEGER TIMESEP INTEGER '
    t = TimeNode(int(p[2]),int(p[4]),int(p[6]))
    t.setAMPM(p[1])
    p[0] = t
