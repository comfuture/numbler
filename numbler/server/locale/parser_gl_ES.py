...
monthdict = {'set': 9, 'xaneiro': 1, 'out': 10, 'feb': 2, 'agosto': 8, 'abr': 4, 'xan': 1, 'maio': 5, 'xullo': 7, 'novembro': 11, 'mar': 3, 'marzo': 3, 'abril': 4, 'xu\xc3\xb1': 6, 'xu\xc3\xb1o': 6, 'mai': 5, 'nov': 11, 'ago': 8, 'outubro': 10, 'febreiro': 2, 'decembro': 12, 'xul': 7, 'dec': 12, 'setembro': 9}
t_SHORTMONTH = r'(?i)xan|feb|mar|abr|mai|xuñ|xul|ago|set|out|nov|dec'
t_LONGMONTH = r'(?i)xaneiro|febreiro|marzo|abril|maio|xuño|xullo|agosto|setembro|outubro|novembro|decembro'
