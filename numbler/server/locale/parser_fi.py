...
monthdict = {'hein\xc3\xa4kuu': 7, 'syyskuu': 9, 'elokuu': 8, 'toukokuu': 5, 'loka': 10, 'elo': 8, 'huhti': 4, 'helmi': 2, 'syys': 9, 'tammi': 1, 'joulukuu': 12, 'joulu': 12, 'huhtikuu': 4, 'maalis': 3, 'marras': 11, 'marraskuu': 11, 'helmikuu': 2, 'hein\xc3\xa4': 7, 'tammikuu': 1, 'touko': 5, 'maaliskuu': 3, 'kes\xc3\xa4kuu': 6, 'lokakuu': 10, 'kes\xc3\xa4': 6}
t_SHORTMONTH = r'(?i)tammi|helmi|maalis|huhti|touko|kesä|heinä|elo|syys|loka|marras|joulu'
t_LONGMONTH = r'(?i)tammikuu|helmikuu|maaliskuu|huhtikuu|toukokuu|kesäkuu|heinäkuu|elokuu|syyskuu|lokakuu|marraskuu|joulukuu'
...
def p_longdate(p):
    ' longdate : INTEGER datesep datesep month CUSTOMLIT0 INTEGER '
    monthasint = False
    day = int(p[1])
    month = p[4]
    year = int(p[6])
