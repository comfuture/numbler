...
monthdict = {'juni': 6, 'nov.': 11, 'august': 8, 'oktober': 10, 'aug.': 8, 'sep.': 9, 'september': 9, 'juli': 7, 'april': 4, 'des.': 12, 'jan.': 1, 'februar': 2, 'mars': 3, 'mai': 5, 'okt.': 10, 'november': 11, 'januar': 1, 'desember': 12, 'feb.': 2}
t_SHORTMONTH = r'(?i)jan\.|feb\.|mars|april|mai|juni|juli|aug\.|sep\.|okt\.|nov\.|des\.'
t_LONGMONTH = r'(?i)januar|februar|mars|april|mai|juni|juli|august|september|oktober|november|desember'
...
def p_meddate(p):
    ' meddate : INTEGER datesep datesep month datesep datesep INTEGER '
    monthasint = False
    day = int(p[1])
    month = p[4]
    year = int(p[7])
...
def p_longdate(p):
    ' longdate : INTEGER datesep datesep month datesep INTEGER '
    monthasint = False
    day = int(p[1])
    month = p[4]
    year = int(p[6])
