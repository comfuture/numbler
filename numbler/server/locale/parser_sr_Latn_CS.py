...
monthdict = {'mart': 3, 'dec': 12, 'mar': 3, 'feb': 2, 'okt': 10, 'sep': 9, 'apr': 4, 'jun': 6, 'jul': 7, 'oktobar': 10, 'jan': 1, 'april': 4, 'novembar': 11, 'februar': 2, 'septembar': 9, 'nov': 11, 'maj': 5, 'avg': 8, 'januar': 1, 'avgust': 8, 'decembar': 12}
t_SHORTMONTH = r'(?i)jan|feb|mar|apr|maj|jun|jul|avg|sep|okt|nov|dec'
t_LONGMONTH = r'(?i)januar|februar|mart|april|maj|jun|jul|avgust|septembar|oktobar|novembar|decembar'
...
t_DAYINWEEK = r'ned|pon|uto|sre|čet|pet|sub|nedelja|ponedeljak|utorak|sreda|četvrtak|petak|subota'
...
def p_longdate(p):
    ' longdate : DAYINWEEK CUSTOMLIT0 datesep INTEGER datesep INTEGER datesep INTEGER datesep '
    monthasint = True
    day = int(p[4])
    month = p[6]
    year = int(p[8])
