...
monthdict = {'1\xec\x9b\x94': 1, '6\xec\x9b\x94': 6, '10\xec\x9b\x94': 10, '2\xec\x9b\x94': 2, '7\xec\x9b\x94': 7, '4\xec\x9b\x94': 4, '12\xec\x9b\x94': 12, '8\xec\x9b\x94': 8, '5\xec\x9b\x94': 5, '9\xec\x9b\x94': 9, '3\xec\x9b\x94': 3, '11\xec\x9b\x94': 11}
t_SHORTMONTH = r'(?i)1월|2월|3월|4월|5월|6월|7월|8월|9월|10월|11월|12월'
t_LONGMONTH = r'(?i)1월|2월|3월|4월|5월|6월|7월|8월|9월|10월|11월|12월'
...
t_CLOCK = r'(?i)am|pm|p|a|오전|오후'
tokens.append('DAYINWEEK')

t_DAYINWEEK = r'일|월|화|수|목|금|토|일요일|월요일|화요일|수요일|목요일|금요일|토요일'
...
def p_longdate(p):
    ' longdate : INTEGER CUSTOMLIT0 datesep INTEGER CUSTOMLIT1 datesep INTEGER CUSTOMLIT2 datesep DAYINWEEK '
    monthasint = True
    day = int(p[7])
    month = p[4]
    year = int(p[1])
...
def p_medtimeclock(p):
    ' medtimeclock : CLOCK SPACE INTEGER CUSTOMLIT3 SPACE INTEGER CUSTOMLIT4 '
    t = TimeNode(int(p[3]),int(p[6]))
    t.setAMPM(p[1])
    p[0] = t


def p_longtimeclock(p):
    ' longtimeclock : CLOCK SPACE INTEGER CUSTOMLIT3 SPACE INTEGER CUSTOMLIT4 SPACE INTEGER CUSTOMLIT5 '
    t = TimeNode(int(p[3]),int(p[6]),int(p[9]))
    t.setAMPM(p[1])
    p[0] = t
