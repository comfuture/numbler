...
monthdict = {'sep': 9, 'apr': 4, 'novembris': 11, 'j\xc5\xablijs': 7, 'feb': 2, 'aug': 8, 'j\xc5\xabnijs': 6, 'maijs': 5, 'jan': 1, 'mar': 3, 'okt': 10, 'septembris': 9, 'decembris': 12, 'oktobris': 10, 'mai': 5, 'j\xc5\xabn': 6, 'nov': 11, 'febru\xc4\x81ris': 2, 'apr\xc4\xablis': 4, 'j\xc5\xabl': 7, 'marts': 3, 'janv\xc4\x81ris': 1, 'dec': 12, 'augusts': 8}
t_SHORTMONTH = r'(?i)jan|feb|mar|apr|mai|jūn|jūl|aug|sep|okt|nov|dec'
t_LONGMONTH = r'(?i)janvāris|februāris|marts|aprīlis|maijs|jūnijs|jūlijs|augusts|septembris|oktobris|novembris|decembris'
...
def p_longdate(p):
    ' longdate : INTEGER CUSTOMLIT0 INTEGER datesep datesep month '
    monthasint = False
    day = int(p[3])
    month = p[6]
    year = int(p[1])
