...
monthdict = {'mee ny nollick': 12, 'j-souree': 7, 'm-souree': 6, 'jerrey-geuree': 1, 'jerrey-fouyir': 10, 'avrril': 4, 'toshiaght-arree': 2, 'mean-souree': 6, 'j-guer': 1, 'm.nollick': 12, 'averil': 4, 'j-fouyir': 10, 'boaldyn': 5, 'mayrnt': 3, 'luanistyn': 8, 'mean-fouyir': 9, 'mee houney': 11, 'm-fouyir': 9, 'm.houney': 11, 'jerrey-souree': 7, 't-arree': 2}
t_SHORTMONTH = r'(?i)j-guer|t-arree|mayrnt|avrril|boaldyn|m-souree|j-souree|luanistyn|m-fouyir|j-fouyir|m\.houney|m\.nollick'
t_LONGMONTH = r'(?i)jerrey-geuree|toshiaght-arree|mayrnt|averil|boaldyn|mean-souree|jerrey-souree|luanistyn|mean-fouyir|jerrey-fouyir|mee houney|mee ny nollick'
...
def p_meddate(p):
    ' meddate : monthday CUSTOMLIT0 INTEGER '
    dn = p[1]
    dn.setYear(int(p[3]))
    p[0] = dn
