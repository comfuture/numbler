...
monthdict = {'julio': 7, 'sep': 9, 'febrero': 2, 'diciembre': 12, 'feb': 2, 'ene': 1, 'junio': 6, 'abril': 4, 'abr': 4, 'oct': 10, 'octubre': 10, 'septiembre': 9, 'mar': 3, 'marzo': 3, 'agosto': 8, 'may': 5, 'mayo': 5, 'jun': 6, 'jul': 7, 'nov': 11, 'ago': 8, 'noviembre': 11, 'enero': 1, 'dic': 12}
t_SHORTMONTH = r'(?i)ene|feb|mar|abr|may|jun|jul|ago|sep|oct|nov|dic'
t_LONGMONTH = r'(?i)enero|febrero|marzo|abril|mayo|junio|julio|agosto|septiembre|octubre|noviembre|diciembre'
...
def p_longdate(p):
    ' longdate : INTEGER CUSTOMLIT1 month CUSTOMLIT1 INTEGER '
    monthasint = False
    day = int(p[1])
    month = p[3]
    year = int(p[5])
