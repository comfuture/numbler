...
monthdict = {'sep': 9, 'apr': 4, 'januar': 1, 'november': 11, 'august': 8, 'feb': 2, 'aug': 8, 'jan': 1, 'september': 9, 'mars': 3, 'desember': 12, 'oktober': 10, 'juni': 6, 'mar': 3, 'okt': 10, 'juli': 7, 'jun': 6, 'jul': 7, 'mai': 5, 'nov': 11, 'des': 12, 'april': 4, 'februar': 2}
t_SHORTMONTH = r'(?i)jan|feb|mar|apr|mai|jun|jul|aug|sep|okt|nov|des'
