...
monthdict = {'jan\xc3\xbaar': 1, 'sep': 9, 'apr': 4, '\xc3\xa1g\xc3\xbast': 8, 'j\xc3\xban': 6, 'j\xc3\xbal': 7, 'feb': 2, '\xc3\xa1g\xc3\xba': 8, 'jan': 1, 'september': 9, 'okt\xc3\xb3ber': 10, 'mars': 3, 'desember': 12, 'ma\xc3\xad': 5, 'mar': 3, 'okt': 10, 'n\xc3\xb3v': 11, 'apr\xc3\xadl': 4, 'j\xc3\xbal\xc3\xad': 7, 'febr\xc3\xbaar': 2, 'j\xc3\xban\xc3\xad': 6, 'des': 12, 'n\xc3\xb3vember': 11}
t_SHORTMONTH = r'(?i)jan|feb|mar|apr|maí|jún|júl|ágú|sep|okt|nóv|des'
t_LONGMONTH = r'(?i)janúar|febrúar|mars|apríl|maí|júní|júlí|ágúst|september|október|nóvember|desember'
