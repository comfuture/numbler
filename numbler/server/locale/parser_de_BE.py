...
monthdict = {'sep': 9, 'apr': 4, 'januar': 1, 'november': 11, 'august': 8, 'm\xc3\xa4rz': 3, 'feb': 2, 'aug': 8, 'jan': 1, 'september': 9, 'oktober': 10, 'juni': 6, 'okt': 10, 'juli': 7, 'jun': 6, 'm\xc3\xa4r': 3, 'dezember': 12, 'jul': 7, 'mai': 5, 'nov': 11, 'dez': 12, 'april': 4, 'februar': 2}
t_SHORTMONTH = r'(?i)jan|feb|mär|apr|mai|jun|jul|aug|sep|okt|nov|dez'
