...
monthdict = {'gr': 12, 'cz': 6, 'pa\xc5\xbadziernika': 10, 'lut': 2, 'sier': 8, 'lip': 7, 'lis': 11, 'wrz': 9, 'grudnia': 12, 'marca': 3, 'kwietnia': 4, 'maj': 5, 'wrze\xc5\x9bnia': 9, 'czerwca': 6, 'mrz': 3, 'lutego': 2, 'maja': 5, 'st': 1, 'sierpnia': 8, 'listopada': 11, 'stycznia': 1, 'kw': 4, 'lipca': 7, 'pa\xc5\xba': 10}
t_SHORTMONTH = r'(?i)st|lut|mrz|kw|maj|cz|lip|sier|wrz|paź|lis|gr'
t_LONGMONTH = r'(?i)stycznia|lutego|marca|kwietnia|maja|czerwca|lipca|sierpnia|września|października|listopada|grudnia'
