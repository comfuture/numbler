...
monthdict = {'februarie': 2, 'sep': 9, 'apr': 4, 'julie': 7, 'augustus': 8, 'januarie': 1, 'nov': 11, 'feb': 2, 'aug': 8, 'junie': 6, 'jan': 1, 'september': 9, 'desember': 12, 'oktober': 10, 'mar': 3, 'okt': 10, 'mei': 5, 'jun': 6, 'jul': 7, 'maart': 3, 'november': 11, 'des': 12, 'april': 4}
t_SHORTMONTH = r'(?i)jan|feb|mar|apr|mei|jun|jul|aug|sep|okt|nov|des'
t_LONGMONTH = r'(?i)januarie|februarie|maart|april|mei|junie|julie|augustus|september|oktober|november|desember'
