...
monthdict = {'feb': 2, 'okt': 10, 'september': 9, 'sep': 9, 'apr': 4, 'jun': 6, 'mei': 5, 'februari': 2, 'jul': 7, 'disember': 12, 'jan': 1, 'april': 4, 'mac': 3, 'januari': 1, 'ogos': 8, 'nov': 11, 'oktober': 10, 'november': 11, 'julai': 7, 'dis': 12}
t_SHORTMONTH = r'(?i)jan|feb|mac|apr|mei|jun|jul|ogos|sep|okt|nov|dis'
t_LONGMONTH = r'(?i)januari|februari|mac|april|mei|jun|julai|ogos|september|oktober|november|disember'
...
def p_medtimeclock(p):
    ' medtimeclock : medtime TIMESEP INTEGER SPACE CLOCK '
    t = p[1]
    t.setAMPM(p[5])
    p[0] = t
