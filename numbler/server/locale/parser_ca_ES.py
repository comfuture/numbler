...
monthdict = {'juny': 6, 'des.': 12, 'febrer': 2, 'juliol': 7, 'oct.': 10, 'ag.': 8, 'octubre': 10, 'set.': 9, 'mar\xc3\xa7': 3, 'jul.': 7, 'desembre': 12, 'gen.': 1, 'abril': 4, 'maig': 5, 'setembre': 9, 'abr.': 4, 'agost': 8, 'novembre': 11, 'gener': 1, 'febr.': 2, 'nov.': 11}
t_SHORTMONTH = r'(?i)gen\.|febr\.|març|abr\.|maig|juny|jul\.|ag\.|set\.|oct\.|nov\.|des\.'
t_LONGMONTH = r'(?i)gener|febrer|març|abril|maig|juny|juliol|agost|setembre|octubre|novembre|desembre'
...
def p_longdate(p):
    ' longdate : INTEGER datesep CUSTOMLIT0 datesep month datesep CUSTOMLIT0 datesep INTEGER '
    monthasint = False
    day = int(p[1])
    month = p[5]
    year = int(p[9])
