...
monthdict = {'ebrill': 4, 'hydref': 10, 'ionawr': 1, 'rhagfyr': 12, 'hyd': 10, 'mawrth': 3, 'chwef': 2, 'chwefror': 2, 'medi': 9, 'meh': 6, 'tach': 11, 'ion': 1, 'rhag': 12, 'mehefin': 6, 'tachwedd': 11, 'gorff': 7, 'mai': 5, 'gorffenaf': 7, 'awst': 8}
t_SHORTMONTH = r'(?i)ion|chwef|mawrth|ebrill|mai|meh|gorff|awst|medi|hyd|tach|rhag'
t_LONGMONTH = r'(?i)ionawr|chwefror|mawrth|ebrill|mai|mehefin|gorffenaf|awst|medi|hydref|tachwedd|rhagfyr'
