...
monthdict = {'studenoga': 11, 'lipnja': 6, 'pro': 12, 'rujna': 9, 'kol': 8, 'srp': 7, 'srpnja': 7, 'lip': 6, 'prosinca': 12, 'lis': 10, 'sij': 1, 'vel': 2, 'ruj': 9, 'o\xc5\xbeu': 3, 'travnja': 4, 'svibnja': 5, 'o\xc5\xbeujka': 3, 'svi': 5, 'tra': 4, 'velja\xc4\x8de': 2, 'stu': 11, 'listopada': 10, 'kolovoza': 8, 'sije\xc4\x8dnja': 1}
t_SHORTMONTH = r'(?i)sij|vel|ožu|tra|svi|lip|srp|kol|ruj|lis|stu|pro'
t_LONGMONTH = r'(?i)siječnja|veljače|ožujka|travnja|svibnja|lipnja|srpnja|kolovoza|rujna|listopada|studenoga|prosinca'
