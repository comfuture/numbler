...
monthdict = {'set': 9, 'apr': 4, 'settembru': 9, 'mejju': 5, 'fra': 2, 'di\xc4\x8b': 12, 'jan': 1, '\xc4\xa0un': 6, 'lul': 7, 'mar': 3, 'ottubru': 10, 'mej': 5, 'frar': 2, 'awi': 8, 'novembru': 11, 'nov': 11, 'ott': 10, 'marzu': 3, '\xc4\xa0unju': 6, 'di\xc4\x8bembru': 12, 'april': 4, 'lulju': 7, 'awissu': 8, 'jannar': 1}
t_SHORTMONTH = r'(?i)jan|fra|mar|apr|mej|Ġun|lul|awi|set|ott|nov|diċ'
t_LONGMONTH = r'(?i)jannar|frar|marzu|april|mejju|Ġunju|lulju|awissu|settembru|ottubru|novembru|diċembru'
...
def p_longdate(p):
    ' longdate : INTEGER datesep CUSTOMLIT0 CUSTOMLIT1 CUSTOMLIT1 datesep month datesep INTEGER '
    monthasint = False
    day = int(p[1])
    month = p[7]
    year = int(p[9])
