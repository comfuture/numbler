...
def p_shortdate(p):
    ' shortdate : INTEGER datesep datesep INTEGER datesep datesep INTEGER '
    monthasint = True
    month = p[4]
    day = int(p[7])
    year = int(p[1])
...
def p_longdate(p):
    ' longdate : INTEGER CUSTOMLIT0 datesep INTEGER CUSTOMLIT1 datesep INTEGER CUSTOMLIT2 '
    monthasint = True
    day = int(p[7])
    month = p[4]
    year = int(p[1])
