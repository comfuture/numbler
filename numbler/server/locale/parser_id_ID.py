...
monthdict = {'sep': 9, 'september': 9, 'nov': 11, 'feb': 2, 'jan': 1, 'apr': 4, 'agustus': 8, 'desember': 12, 'oktober': 10, 'juni': 6, 'mar': 3, 'okt': 10, 'mei': 5, 'juli': 7, 'jun': 6, 'jul': 7, 'november': 11, 'maret': 3, 'des': 12, 'april': 4, 'februari': 2, 'januari': 1, 'agu': 8}
t_SHORTMONTH = r'(?i)jan|feb|mar|apr|mei|jun|jul|agu|sep|okt|nov|des'
t_LONGMONTH = r'(?i)januari|februari|maret|april|mei|juni|juli|agustus|september|oktober|november|desember'
