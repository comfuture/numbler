...
monthdict = {'apr': 4, 'fevral': 2, 'avq': 8, 'oktyabr': 10, 'noyabr': 11, 'sen': 9, 'fev': 2, 'dekabr': 12, 'mart': 3, 'yan': 1, 'mar': 3, 'okt': 10, 'may': 5, 'yanvar': 1, 'sentyabr': 9, 'noy': 11, '\xc4\xb0yun': 6, '\xc4\xb0yul': 7, 'aprel': 4, 'iyl': 7, 'iyn': 6, 'dek': 12, 'avqust': 8}
t_SHORTMONTH = r'(?i)yan|fev|mar|apr|may|iyn|iyl|avq|sen|okt|noy|dek'
t_LONGMONTH = r'(?i)yanvar|fevral|mart|aprel|may|İyun|İyul|avqust|sentyabr|oktyabr|noyabr|dekabr'
